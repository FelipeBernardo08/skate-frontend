...
export class ProfileComponent implements OnInit {
  ...
  changePassword(): void {
    this.conditionChangePassword = !this.conditionChangePassword;
  }

  showPassword(pass: number): void {
    if (pass == 1) {
